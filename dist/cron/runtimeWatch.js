...
export function runtimeWatchIntervalMs(env = process.env) {
...
export async function refreshTenantRuntimeWatch(instanceId, domain = "") {
    ...
    const snapshot = buildSnapshot(runtime, kitchen, notes);
