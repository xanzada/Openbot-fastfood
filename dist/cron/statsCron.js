...
function buildFallbackAnalytics(logs = [], reason = "") {
  const blob = logs.map((log) => [log.action, log.interest, log.sales_stage, log.psycho_analysis, log.text].map(asText).join(" ")).join("\n").toLowerCase();
  ...
  return {
    ...
    ai_daily_advice: totalChats > 0 ? "\u0411\u04AF\u0433\u0456\u043D\u0433\u0456 \u0434\u0438\u0430\u043B\u043E\u0433\u0442\u0430\u0440 \u0441\u0430\u049B\u0442\u0430\u043B\u0434\u044B. \u0422\u043E\u043B\u044B\u049B AI \u0442\u0430\u043B\u0434\u0430\u0443 \u0443\u0430\u049B\u044B\u0442\u0448\u0430 \u049B\u043E\u043B\u0436\u0435\u0442\u0456\u043C\u0441\u0456\u0437 \u0431\u043E\u043B\u0441\u0430 \u0434\u0430, \u043D\u0435\u0433\u0456\u0437\u0433\u0456 \u0441\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430 \u0436\u0430\u0437\u044B\u043B\u0434\u044B." : "\u0411\u04AF\u0433\u0456\u043D \u0431\u043E\u0442\u049B\u0430 \u0436\u0430\u04A3\u0430 \u0434\u0438\u0430\u043B\u043E\u0433 \u0442\u04AF\u0441\u043F\u0435\u0434\u0456.",
...
function startDailyCron() {
  const scheduleNext = () => {
    ...
    setTimeout(() => {
      processDailyAnalytics().catch((error) => {
