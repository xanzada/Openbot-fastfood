...
export function normalizeMenuDomain(domain) {
...
export function hasExplicitMenuLinkIntent(text) {
    ...
    return (/(сілтеме|ссылка|link|линк|мәзір|меню|каталог|тапсырыс\s*(бер|берейін|берем|жасай|ет|қыл)|заказ\s*(бер|берейін|берем|жасай|ет|қыл|хочу|сдел|оформ)|заказать|оформить|хочу\s+заказ|хочу\s+заказать|корзин|себет|меню жібер|мәзір жібер|меню бер|мәзір бер|қалай заказ|қалай тапсырыс)/iu.test(value) ||
