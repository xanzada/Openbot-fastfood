...
export function hasExplicitMenuLinkIntent(text) {
    ...
    return /(сілтеме|ссылка|link|линк|меню жібер|мәзір жібер|меню бер|мәзір бер|қайта жібер|жоғалтып|өшіп|қалай заказ|қалай тапсырыс|заказ бер|тапсырыс бер)/iu.test(value);
}
