...
export function createGetBusinessInfoSkill(ctx) {
    return createTool({
        name: "getBusinessInfo",
        description: "Return only customer-safe restaurant information from the current instance: work hours, this bot's WhatsApp phone, brand, and address. Never return any secret platform field.",
        parameters: z.object({
