...
import type { BckndListGenericSecretsResponse, BckndGenericSecretPostBody, BckndGenericSecretDataResponse, BckndGenericSecretDetails, BckndGenericSecretPatchBody } from './schema/index.js';
/**
...
export declare const SecretApi: {
     ...
     */
    kubesubmitV4GenericSecretsGetAll: (queryParameters?: {
        $top?: number;
        $skip?: number;
        $count?: boolean;
    }, headerParameters?: {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    kubesubmitV4GenericSecretsGet: (secretName: string, headerParameters?: {
        Authorization?: string;
        "AI-Resource-Group"?: string;
        "AI-Tenant-Scope"?: boolean;
