...
import type { BckndAllArgoCDApplicationData, BckndArgoCDApplicationDataRequest, BckndArgoCDApplicationDataRepoName, BckndArgoCDApplicationCreationResponse, BckndArgoCDApplicationStatus, BckndArgoCDApplicationDataResponse, BckndArgoCDApplicationBaseData, BckndArgoCDApplicationModificationResponse, BckndArgoCDApplicationDeletionResponse, BckndArgoCDApplicationRefreshResponse } from './schema/index.js';
/**
...
export declare const ApplicationApi: {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    kubesubmitV4ApplicationsCreate: (body: BckndArgoCDApplicationDataRequest | BckndArgoCDApplicationDataRepoName, headerParameters?: {
        Authorization?: string;
