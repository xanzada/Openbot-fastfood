...
var PropertiesHandler = class {
  apply(types, schema) {
    ...
    let objectZod = import_v49.z.object(shape);
    ...
    if (enforcibleKeys.length > 0) {
      types.object = objectZod.refine(
        (value) => enforcibleKeys.every((key) => Object.prototype.hasOwnProperty.call(value, key)),
...
var ObjectPropertiesHandler = class {
  apply(zodSchema, schema) {
    ...
    const isDirectObject = zodSchema instanceof import_v412.z.ZodObject || zodSchema instanceof import_v412.z.ZodRecord;
