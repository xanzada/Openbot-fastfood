 ...
 * @internal
 */
export type ParametersType<ApiT, FnT extends keyof ApiT> = ApiT[FnT] extends (...args: any) => any ? Parameters<ApiT[FnT]> : never;
/**
 ...
 * @internal
 */
export type FunctionReturnType<ApiT, FnT extends keyof ApiT> = ApiT[FnT] extends (...args: any) => any ? UnPromisify<ReturnType<ApiT[FnT]>> : never;
/**
