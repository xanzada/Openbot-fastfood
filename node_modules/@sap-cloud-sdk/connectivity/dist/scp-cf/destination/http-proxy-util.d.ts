...
import type { BasicProxyConfiguration, ProxyConfiguration } from '../connectivity-service-types';
 ...
 * @internal
 */
export declare function getProxyConfig(destination: HttpDestination): BasicProxyConfiguration | false;
export {};
