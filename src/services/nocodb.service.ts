...
function safeJsonObject(value: unknown, fallback: any = null) {
...
function scoreShporRecord(item: Record<string, any>, query = "") {
...
function selectRelevantShpor(records: any[] = [], query = "", limit = SHPOR_CONTEXT_LIMIT) {
