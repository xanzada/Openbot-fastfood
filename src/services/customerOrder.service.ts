...
export function orderNextStepLine(order:CustomerOrder,language:"kk"|"ru"){
  ...
  if(/готов|дайын/.test(label)) return language==="ru"?"Можете забирать — всё упаковано.":"Алып кетуге болады — бәрі дайын.";
  ...
  if(/готовит|даярла|дайындал/.test(label)) return language==="ru"?"Как только будет готово, сразу напишем.":"Дайын болған сәтте бірден хабарлаймыз.";
