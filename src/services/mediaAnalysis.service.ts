...
function getOpenRouterMediaPart(inlineData: { data: string; mimeType: string }, filename = "media") {
...
export async function analyzeMedia(
  ...
  try {
    ...
    if (!OPENROUTER_API_KEY) return fallbackTechnicalError(new Error("OPENROUTER_API_KEY_NOT_CONFIGURED"), userLang);
