...
Hub оны тапсырыстың комментарии ретінде сақтауы керек — оператор чекте дәл осыны
тексереді; `note` келмесе бұрынғы қалыптас коммент («Клиент отправил чек») қалады.
